# Fine tuning gpt2-large on my Olympics dataset :)
...
training_args = TrainingArguments(
    output_dir="/homes/cgaponte/ProgDS/TermProject/gpt2-large_olympics_finetuned",
...
trainer.save_model("/homes/cgaponte/ProgDS/TermProject/gpt2-large_olympics_finetuned_model")
